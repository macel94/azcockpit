...
- [ ] Phase 3: Microsoft Graph enrichment (tenant display names), multi-select secrets, search/filter
- [ ] Phase 4: Cross-platform release binaries (goreleaser), Homebrew tap
